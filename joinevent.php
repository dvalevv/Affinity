...
*/
            echo '<div class="col-7"> <p>' . $eventName . '</p><p>' . $eventLocation . '. ' . $eventExpirationDate . '</p> <form action="" method="POST"><input type="submit" name="Search" value="Find a Match"></form><form name="join" method="post" action="eventJoin.php">
          Join the event
